...
<html lang="en">
  ...
  <body>
    ...
    if($link === false){
      ...
      $sql = "SELECT id ,name, email, phone, birth, gender, address, course FROM courses";
      //fire query
      $result = mysqli_query($link, $sql);
      if(mysqli_num_rows($result) > 0)
        {
          echo '<table> <tr> <th> id </th> <th> Name </th> <th> Email </th> <th> Phone </th> <th> Birth </th> <th> Gender </th> <th> Address </th> <th> Course </th>     </tr>';
